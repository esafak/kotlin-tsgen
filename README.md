...
| Polymorphism - Sealed classes         | ✅   [example](./docs/polymorphism-sealed.md#sealed-classes)     | Nested sealed subclasses are flattened; [see notes](./docs/polymorphism-sealed.md#nested-sealed-classes) |
